    ...
    <div class="contenedor-scroll">
        ...
        while ($row = $resultado->fetch_assoc()) { ?>
            <div class="card-client">
                ...
                Rol: <span><?php echo $row['nombre_rol'] ? $row['nombre_rol'] : 'Sin rol'; ?></span><br>
                <button>Historial</button><br>
        <button>Eliminar</button><br>
        <button>EditarRol</button>
            </div>
        <?php } ?>
...
<?php
   ...
   <div class="user-picture">
                ...
                <p class="name-client"><?php echo $row['nombre']; ?><br></p>
                <span><?php echo $row['nombre_rol'] ? $row['nombre_rol'] : 'Sin rol'; ?></span><br>
    </div>
